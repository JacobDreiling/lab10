...
chimney = drawpad.create_rectangle(200,270,300,300, fill = '#C9DEFF', outline = '')
windo1 = drawpad.create_rectangle(550, 280, 640, 350, fill = '#C9EDFF')
windo2 = drawpad.create_rectangle(550, 430, 640, 500, fill = '#C9EDFF')
dor = drawpad.create_rectangle(200, 450, 350, 540, fill = '#D1FAFF')
bar = drawpad.create_rectangle(265, 450, 285, 540, fill = 'grey')
